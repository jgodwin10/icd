  ...
  return (
    <div className="md:px-[50px] py-20 px-6">
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="bg-[url('/src/Images/slide.jpeg')] mt-6 before:absolute before:contents-[''] before:top-0 before:w-full before:h-full before:bg-[#00000096] relative bg-cover bg-center h-[60vh] md:h-[60vh] w-full">
